...
def main():
    ...
    if is_main:
        print("=" * 80)
        print("[Stage 3] More data + sharpen — resume from Stage 2, cosine LR")
    ...
    model = train_coarse_matching_model(
        ...
        save_dir="checkpoints/coarseflow_swin3d_v2_stage3",
        ...
        **model_config,
        ...
        resume_path="checkpoints/coarseflow_swin3d_v2_stage2/best.pth",
