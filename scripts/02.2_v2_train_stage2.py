...
def main():
    ...
    if is_main:
        print("=" * 80)
        print("[Stage 2] Harder data + sharpen — resume from Stage 1, cosine LR")
    ...
    model = train_coarse_matching_model(
        ...
        save_dir="checkpoints/coarseflow_swin3d_v2_stage2",
        ...
        **model_config,
        ...
        resume_path="checkpoints/coarseflow_swin3d_v2_stage1/best.pth",
