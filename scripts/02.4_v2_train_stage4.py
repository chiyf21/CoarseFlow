...
def main():
    ...
    if is_main:
        print("=" * 80)
        print("[Stage 4] Spatial residual refinement — freeze coarse, cosine LR")
    ...
    model_config = dict(
        ...
        # =====================================================
        # Residual refinement: ON for Stage 4
        # =====================================================
    ...
    model_stage1 = train_coarse_matching_model(
        ...
        save_dir="checkpoints/coarseflow_swin3d_v2_stage4",
        ...
        **model_config,
        ...
        resume_path="checkpoints/coarseflow_swin3d_v2_stage3/best.pth",
