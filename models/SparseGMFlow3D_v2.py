# SparseGMFlow3D_v2.py
# Clean V6 implementation:
...
class MovingQueryEncoderV3(nn.Module):
    """
...
class ReferenceMemoryEncoderV4(nn.Module):
    """
...
class LocalQueryToVolumeMatcherV2(nn.Module):
    ...
    It keeps the previous V5 design:
...
# ============================================================
# Full model: CoarseMatchingNetV6
# ============================================================

class CoarseMatchingNetV6(nn.Module):
    """
    ...
    def __init__(
        ...
        # ----------------------------------------------------
        self.moving_encoder = MovingQueryEncoderV3(
            in_ch=1,
            dim=dim,
        ...
        self.reference_encoder = ReferenceMemoryEncoderV4(
            in_ch=1,
            dim=dim,
    ...
    def downsample_query_features(self, F_mov, input_hw):
        ...
        For the default V6 setting, moving encoder output stride and
...
__all__ = [
    "CoarseMatchingNetV6",
    "MovingQueryEncoderV3",
    "ReferenceMemoryEncoderV4",
    "LocalQueryToVolumeMatcherV2",
